-- Fix race condition in message embeddings by using proper locking
...
BEGIN
    ...
    -- This must be done before any other operations to prevent deadlocks
    PERFORM 1
    ...
    -- Mark existing embeddings as not latest within the same transaction
    ...
    -- Insert new version with explicit transaction handling
    BEGIN
    ...
    EXCEPTION 
        WHEN unique_violation THEN
            -- If we hit a unique violation, wait a bit and retry
